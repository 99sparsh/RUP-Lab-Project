...
public class DeleteHotel extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       Statement stmt = null;
       String query1="delete from hotels where id="+jTextField1.getText();
       String query3="select admin_id from hotels where id="+jTextField1.getText();
       try{
           stmt=conn.createStatement();
           ResultSet rs = stmt.executeQuery(query3);
           rs.next();
           int haid = rs.getInt("admin_id");
           stmt=conn.createStatement();
           stmt.executeUpdate(query1);
           String query2="delete from hotel_admin where id="+haid;
